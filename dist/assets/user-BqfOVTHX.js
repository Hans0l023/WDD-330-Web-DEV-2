import{l as s}from"./utils-DXYwRS0d.js";function i(){const a=document.querySelector("#favorites");let t=JSON.parse(localStorage.getItem("favorites"))||[];t.length>0?(a.innerHTML=t.map(e=>`
